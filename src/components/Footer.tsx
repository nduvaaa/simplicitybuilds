      ...
      <div className="container-custom">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <a href="#" className="text-2xl font-bold flex items-center">
              <span className="bg-white text-blue-500 p-1 rounded mr-2">SB</span>
              Simplicity<span className="text-blue-300">Builds</span>
            </a>
            <p className="mt-2 text-blue-200 max-w-md">
              Delivering exceptional web solutions that drive business growth and digital transformation.
            </p>
          </div>
        ...
        <div className="border-t border-blue-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-blue-200 text-sm">
            © {currentYear} SimplicityBuilds. All rights reserved.
          </p>
